...
![Diagram that shows a landing zone design.](https://github.com/huqianghui/cloud-adoption-framework/blob/deploylz-mooncake/docs/ready/enterprise-scale/media/lz-design.png)
